...
<body id="container-page-index">
    ...
    <section id="slider-viajitico" class="carousel slide" data-ride="carousel" style="padding: 0;">

        <!-- Indicators 
        <ol class="carousel-indicators">
            <li data-target="#slider-viajitico" data-slide-to="0" class="active"></li>
            <li data-target="#slider-viajitico" data-slide-to="1"></li>
            <li data-target="#slider-viajitico" data-slide-to="2"></li>
        </ol>
        -->
        <!-- Wrapper for slides -->
        ...
        <!-- Controls -->
        <a class="left carousel-control" href="#slider-viajitico" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control" href="#slider-viajitico" role="button" data-slide="next">
